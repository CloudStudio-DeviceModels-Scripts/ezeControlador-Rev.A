...
# Parsing + Configuration Script – ezeControlador - Rev. A

This **Parsing + Configuration** script is designed for the **ezeControlador** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ezeControlador Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ezeControlador** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
