...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Ultracongelador 1 - temp superior", endpointType.temperatureSensor);
  endpoints.addEndpoint("2", "Ultracongelador 1 - temp inferior", endpointType.temperatureSensor);
  endpoints.addEndpoint("3", "Ultracongelador 2 - temp superior", endpointType.temperatureSensor);
  endpoints.addEndpoint("4", "Ultracongelador 2 - temp inferior", endpointType.temperatureSensor);
  endpoints.addEndpoint("5", "Ultracongelador 1 - Puerta", endpointType.iasSensor, iasEndpointSubType.doorSensor);
  endpoints.addEndpoint("6", "Ultracongelador 2 - Puerta", endpointType.iasSensor, iasEndpointSubType.doorSensor);
  endpoints.addEndpoint("7", "Ultracongelador 1 - alarma HAIER", endpointType.iasSensor, iasEndpointSubType.alarmInput);
  endpoints.addEndpoint("8", "Ultracongelador 2 - alarma HAIER", endpointType.iasSensor, iasEndpointSubType.alarmInput);
  endpoints.addEndpoint("9", "Sala técnica - temperatura ambiente", endpointType.temperatureSensor);
  endpoints.addEndpoint("10", "Sala técnica - humedad relativa", endpointType.humiditySensor);
}
